...
class TalksControllerTest < ActionController::TestCase
  ...
  test "should create talk" do
    assert_difference('Talk.count') do
      post :create, talk: { date: @talk.date, description: @talk.description, speaker_id: @talk.speaker_id, title: @talk.title }
    end
  ...
  test "should update talk" do
    patch :update, id: @talk, talk: { date: @talk.date, description: @talk.description, speaker_id: @talk.speaker_id, title: @talk.title }
    assert_redirected_to talk_path(assigns(:talk))
  end
